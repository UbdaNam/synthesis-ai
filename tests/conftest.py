    ...
    config.write_text(
        "\n".join(
            [
                ...
                "chunking:",
                "  rule_version: chunking-v1-test",
                "  max_tokens_per_chunk: 12",
                "  numbered_list_split_threshold: 12",
                "  table_row_group_limit: 2",
                "  reference_resolution_behavior: resolve_if_known",
                "  section_heading_block_types: [heading]",
                "  chunking_ledger_path: .refinery/chunking_ledger.test.jsonl",
            ]
        ),
        encoding="utf-8",
    )
