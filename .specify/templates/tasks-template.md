...
- [ ] T010 Define typed inter-stage Pydantic contracts (no untyped dictionaries)
- [ ] T011 Implement extraction Strategy interface and clear agent/strategy separation
...
### Tests for User Story 1 (MANDATORY FOR GOVERNED BEHAVIOR)
...
- [ ] TXXX [P] Additional unit/validation/regression tests in tests/
...
Task: "Unit test for classification in tests/unit/test_classification.py"
Task: "Unit test for confidence scoring in tests/unit/test_confidence.py"
Task: "Unit test for escalation routing in tests/unit/test_escalation_routing.py"
Task: "Validation test for chunking invariants in tests/validation/test_chunking.py"
Task: "Regression test for extraction failure in tests/regression/test_extraction_failure_[name].py"

# Launch all models for User Story 1 together:
Task: "Create typed models in src/models/[entity1].py"
Task: "Create typed models in src/models/[entity2].py"
```
